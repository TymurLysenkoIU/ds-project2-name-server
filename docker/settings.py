"""
Django settings for name_server_proj project.
...
SECRET_KEY = environ.get("DJANGO_SECRET_KEY", 'dw2&_5kzulrn5mo$sjyay^oz*fjklr+d^i5396fd2adi!7x4wf')
...
ROOT_URLCONF = 'name_server_proj.urls'
...
WSGI_APPLICATION = 'name_server_proj.wsgi.application'
...
MONGO_PASSWORD = environ.get("MONGO_PASS", 'mongo')
